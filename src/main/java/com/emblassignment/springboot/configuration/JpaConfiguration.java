package com.emblassignment.springboot.configuration;
...
//@Configuration
//@Profile("local")
//@EnableJpaRepositories(basePackages = "com.emblassignment.springboot.repositories",
...
public class JpaConfiguration {/*
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.emblassignment.springboot.model" });
